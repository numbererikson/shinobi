// Types for the fitness reference plugin. Mirrors SPEC_shinobi_plugin_fitness
// v0.2.0. The plugin stores and returns structured facts only — never natural
// language coaching; the LLM turns these into words.
